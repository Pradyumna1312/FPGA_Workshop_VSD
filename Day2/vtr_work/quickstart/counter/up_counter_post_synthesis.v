//Verilog generated by VPR 8.1.0-dev+5845ee0f4 from post-place-and-route implementation
module up_counter (
    ...
    //Interconnect
    fpga_interconnect \routing_segment_up_counter^enable_output_0_0_to_lut_n22_input_0_1  (
    ...
    fpga_interconnect \routing_segment_up_counter^enable_output_0_0_to_lut_n32_input_0_1  (
        .datain(\up_counter^enable_output_0_0 ),
        .dataout(\lut_n32_input_0_1 )
    );

    fpga_interconnect \routing_segment_up_counter^enable_output_0_0_to_lut_n27_input_0_3  (
        .datain(\up_counter^enable_output_0_0 ),
        .dataout(\lut_n27_input_0_3 )
    );
    ...
    fpga_interconnect \routing_segment_up_counter^reset_output_0_0_to_lut_n22_input_0_2  (
    ...
    fpga_interconnect \routing_segment_up_counter^reset_output_0_0_to_lut_n32_input_0_3  (
        .datain(\up_counter^reset_output_0_0 ),
        .dataout(\lut_n32_input_0_3 )
    );
    ...
    fpga_interconnect \routing_segment_adder_up_counter^ADD~4-2[0]_output_1_0_to_lut_n37_input_0_0  (
    ...
    fpga_interconnect \routing_segment_adder_up_counter^ADD~4-3[0]_output_1_0_to_lut_n32_input_0_2  (
    ...
    fpga_interconnect \routing_segment_latch_up_counter^out~1_FF_output_0_0_to_lut_n37_input_0_1  (
        .datain(\latch_up_counter^out~1_FF_output_0_0 ),
        .dataout(\lut_n37_input_0_1 )
    );
    ...
    fpga_interconnect \routing_segment_latch_up_counter^out~2_FF_output_0_0_to_lut_n32_input_0_0  (
