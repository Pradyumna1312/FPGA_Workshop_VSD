create_clock -period 480000.000 -name clk -waveform {0.000 240000.000} [get_ports clk]
...
set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports {out[*]}]
